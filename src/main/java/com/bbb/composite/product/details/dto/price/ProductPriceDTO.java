...
/**
 * ProductPriceDTO attributes specified here.
 * 
 * @author psh111
 *
 */
public class ProductPriceDTO implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5478740366139750991L;
	 ...
	 *            the priceRangeDescription to set
	 */
	...
	/**
	 * @param productLowSalePrice
	 *            the productLowSalePrice to set
	 */
	...
	/**
	 * @param productHighSalePrice
	 *            the productHighSalePrice to set
	 */
	...
	/**
	 * @param productLowListPrice
	 *            the productLowListPrice to set
	 */
	...
	/**
	 * @param productHighListPrice
	 *            the productHighListPrice to set
	 */
	...
	/**
	 * @param productInCartFlag
	 *            the productInCartFlag to set
	 */
	...
	/**
	 * @param productLabelCode
	 *            the productLabelCode to set
	 */
	...
	/**
	 * @param productInCartPrice
	 *            the productInCartPrice to set
	 */
	...
	public String toString() {
		...
		builder.append("ProductPriceEntity [productId=");
