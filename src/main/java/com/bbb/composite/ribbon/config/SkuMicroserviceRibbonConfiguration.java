 ...
 */
@Configuration
public class SkuMicroserviceRibbonConfiguration extends BaseRibbonConfiguration {

	private String skuMicroservice = "sku-microservice";
    ...
    public IClientConfig ribbonClientConfig() {
        ...
        config.loadProperties(this.skuMicroservice);
        return config;
    }
